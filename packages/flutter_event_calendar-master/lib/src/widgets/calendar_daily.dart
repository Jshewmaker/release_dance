...
class CalendarDaily extends StatelessWidget {
  CalendarDaily({Key? key, required this.specialDays, this.onCalendarChanged})
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          if (DayOptions.of(context).disableFadeEffect)
            const SizedBox()
          else
            Align(
  ...
  Future<void> executeAsync(BuildContext context) async {
